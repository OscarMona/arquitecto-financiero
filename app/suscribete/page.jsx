...
export default function Suscribete() {
  ...
  const C = {
    ...
    accent: "#00E8B8", danger: "#FF4D6A", warning: "#FFB443",
    ...
    <div style={{ background: C.bg, minHeight: "100vh", color: C.t1, fontFamily: "'DM Sans',system-ui,sans-serif", display: "flex", flexDirection: "column", alignItems: "center", padding: "0 16px 60px" }}>
      ...
      <div style={{ maxWidth: 420, width: "100%", textAlign: "center", marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: C.t2, lineHeight: 1.7, margin: 0 }}>
          La mayoría de las personas gana bien — pero llega a cero sin saber por qué. No es un problema de ingresos. Es un problema de control.
        </p>
      </div>
      ...
      <div style={{ maxWidth: 420, width: "100%", marginBottom: 28 }}>
        {[
          { icon: "😰", text: "Ganas bien pero el dinero desaparece" },
          { icon: "😓", text: "No sabes en qué te gastas el dinero" },
          { icon: "😤", text: "Llegas a fin de mes sin saber qué pasó" },
          { icon: "😔", text: "No tienes ahorro aunque quisieras" },
        ].map((d, i) => (
      ...
      <div style={{ maxWidth: 420, width: "100%", background: C.card, borderRadius: 16, padding: 20, border: `1px solid ${C.accent}22`, marginBottom: 28 }}>
        ...
        {[
          "📊 Ve exactamente en qué gastas cada peso",
          "🎯 Presupuesto real adaptado a tu vida",
          "💸 Flujo de caja para que nada te agarre desprevenido",
          "🤖 IA que clasifica tus gastos automáticamente",
          "📅 Alertas de pagos grandes antes de que lleguen",
        ].map((b, i) => (
      ...
      <div style={{ maxWidth: 420, width: "100%", textAlign: "center", marginBottom: 28 }}>
        ...
        <div style={{ fontFamily: "'Sora',sans-serif", fontSize: 48, fontWeight: 800, color: C.accent, lineHeight: 1 }}>$4.99</div>
        <div style={{ fontSize: 14, color: C.t2, marginTop: 4 }}>USD al mes — menos que un café</div>
      ...
      <div style={{ maxWidth: 420, width: "100%", marginBottom: 16 }}>
        ...
        <input
          ...
          onKeyDown={e => e.key === "Enter" && handlePago()}
          style={{ width: "100%", boxSizing: "border-box", padding: "14px 16px", borderRadius: 12, background: C.card, border: `1px solid ${C.border}`, color: C.t1, fontSize: 15, outline: "none", marginBottom: 10 }}
        />
        ...
        <button
          onClick={handlePago}
          disabled={loading}
          style={{ width: "100%", padding: "16px", borderRadius: 12, border: "none", background: loading ? C.border : C.accent, color: "#000", fontSize: 16, fontWeight: 800, cursor: loading ? "default" : "pointer", transition: "all 0.2s" }}
        >
          {loading ? "Conectando..." : "Quiero tomar control de mi dinero →"}
        </button>
