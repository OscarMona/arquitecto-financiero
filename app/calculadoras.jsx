...
function SimuladorPresupuesto({ mob }) {
  ...
  const proyeccion = MESES.map((m,i) => ({ mes:m, acumulado: balance*(i+1) }));
  ...
  return (
    <div style={{animation:"fadeIn 0.3s"}}>
      ...
      {/* PROYECCIÓN ANUAL */}
      {totalIng>0&&<Card style={{marginBottom:16}} glow={!deficit}>
      ...
      {/* CTA */}
      <div style={{textAlign:"center",padding:"20px 0",background:C.card,borderRadius:16,border:`1px solid ${C.accent}22`,marginBottom:8}}>
        <div style={{fontSize:14,fontWeight:700,color:C.t1,marginBottom:6}}>¿Quieres saber si realmente lo estás logrando?</div>
        <div style={{fontSize:12,color:C.t2,marginBottom:16,maxWidth:340,margin:"0 auto 16px"}}>La App Pro mide tu presupuesto vs lo que realmente gastas, día a día.</div>
